...
func callbackCatch(args []string) error {
	...
	// Use math/rand to decide if the Pokémon is caught
	rand.Seed(time.Now().UnixNano() * int64(pokemon.BaseExperience))
	catchChance := rand.Intn(100) // Generate a random number between 0 and 99
